...
module Lib
  module TL1
    module Huawei
      module Message
        # Queries performance statistics for an ONT Ethernet port.
        class LstOntEthPortPerf < Lib::TL1::Huawei::Message::Input
          ...
          def initialize(
            ...
            set_attributes(
              ...
              ont_port_id:, ont_port_type:
            )
            super(
              aid: hash_to_string(
                did: did, dev: dev, fn: frame_number, sn: slot_number, pn: port_number,
                ont_id: ont_id, name: ont_name, alias: ont_alias, ont_port_type: ont_port_type,
