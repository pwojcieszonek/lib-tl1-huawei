...
module Lib
  module TL1
    module Huawei
      module Message
        # Queries ONTs by identity, location, or running state.
        class LstOnt < Lib::TL1::Huawei::Message::Input
          ...
          def initialize(
            ...
            set_attributes(
              onu_name:, ont_sn:, ont_pwd:, did:, dev:, frame_number:, slot_number:, port_number:,
              ont_id:, run_state: run_stat, onu_did:, onu_dev:, show_option:
            )
            super(
              aid: hash_to_string(
                name: onu_name, ont_sn: ont_sn, pwd: ont_pwd, did: did, dev: dev, fn: frame_number,
